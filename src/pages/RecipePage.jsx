...
export const RecipePage = ({ recipe }) => {
  return (
    <Container h="100vh" mt="5" flexDirection="column" maxW="60%">
      <Card>
        <CardBody padding="0">
          <Image
            h="300px"
          ...
          <SimpleGrid spacing="5" m="7" minChildWidth="50px">
            <Box>
              <Text
                fontSize="14px"
                color="grey"
              ...
              <Heading size="md" mt="1" fontWeight="medium">
                {recipe.recipe.label}
              </Heading>
              <Flex gap="2" mt="3">
              ...
              <Box mt="2">
                ...
                {recipe.recipe.ingredientLines.map((ingredient) => {
                  return (
                    <Text lineHeight="2" key={ingredient}>
                      {ingredient}
                    </Text>
                  );
                })}
